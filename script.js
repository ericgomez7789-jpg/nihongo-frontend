...

{
  ...
  options: ["もり", "では", "いろいろな", "どうぶつが", "ウロウロと", "みちくさ", "します"],
  optionsRomaji: ["mori", "dewa", "iroiro na", "doubutsu ga", "urouro to", "michikusa", "shimasu"],
  optionsEN: [
    "forest",
    "at / in",
    "various",
...

{
  ...
  options: ["どうぶつ", "は", "あしおとが", "ずしずしと", "おちる"],
  optionsRomaji: ["doubutsu", "wa", "ashioto ga", "zushizushi to", "ochiru"],
  optionsEN: [
    "animals",
    "topic marker",
    "footsteps (subject)",
...

{
  ...
  options: ["かぜでは", "くさが", "ゆらゆらと", "ゆれます"],
  optionsRomaji: ["kaze dewa", "kusa ga", "yurayura to", "yuremasu"],
  optionsEN: [
    "in the wind",
    "grass (subject)",
    "gently swaying",
  ...
  chunks: [
    {
      ...
      meaning: "spring",
      audio: {
        daughter: "audio/sentences/haru.wav",
        me: "audio/sentences/haru.wav"
      }
    },
    {
      romaji: "niwa",
...

{
  ...
  options: ["くうき", "では", "はなが", "ふわっと", "においがします"],
  optionsRomaji: ["kuuki", "dewa", "hana ga", "fuwatto", "nioi ga shimasu"],
  optionsEN: [
    "air",
    "in / through",
    "flowers (subject)",
  ...
  chunks: [
    {
      ...
      meaning: "air",
      audio: {
        daughter: "audio/sentences/kuuki.wav",
        me: "audio/sentences/kuuki.wav"
      }
    },
    {
      romaji: "dewa",
  ...
  chunks: [
    {
      ...
      meaning: "cliff",
      audio: {
        daughter: "audio/sentences/gake.wav",
        me: "audio/sentences/gake.wav"
      }
    },
    {
      romaji: "no",
    ...
    },
    {
      ...
      meaning: "edge",
      audio: {
        daughter: "audio/sentences/fuchi.wav",
        me: "audio/sentences/fuchi.wav"
      }
    },
    {
      romaji: "dewa",
...

{
  ...
  choiceAudio: {
    options: [
      ...
      "audio/sentences/ga.wav",
      "audio/sentences/yamu.wav",
      "audio/sentences/to.wav",
      "audio/sentences/amashizuku.wav",
      "audio/sentences/ga.wav",
      "audio/sentences/poroporo_to.wav",
...

{
  ...
  options: ["かざん", "では", "ようがんが", "どばどばと", "ほとばしる"],
  optionsRomaji: ["kazan", "dewa", "yougan ga", "dobadoba to", "hotobashiru"],
  optionsEN: [
    "volcano",
    "at",
    "lava (subject)",
  ...
  choiceAudio: {
    options: [
      "audio/sentences/kazan.wav",
      "audio/sentences/dewa.wav",
      "audio/sentences/yougan_ga.wav",
      "audio/sentences/dobadoba_to.wav",
  ...
  chunks: [
    {
      ...
      meaning: "volcano",
      audio: {
        daughter: "audio/sentences/kazan.wav",
        me: "audio/sentences/kazan.wav"
      }
    },
    {
      romaji: "dewa",
    ...
    },
    {
      ...
      audio: {
        daughter: "audio/sentences/yougan_ga.wav",
        me: "audio/sentences/yougan_ga.wav"
      }
    },
    {
      romaji: "dobadoba to",
...

{
  ...
  options: ["やま", "では", "おねが", "ぎざぎざとして", "かたちつくっている"],
  optionsRomaji: ["yama", "dewa", "one ga", "gizagiza to shite", "katachitsukutte iru"],
  optionsEN: [
    "mountain",
    "in / at",
    "ridge (subject)",
  ...
  chunks: [
    {
      ...
      meaning: "quietness",
      audio: {
        daughter: "audio/sentences/shizukesa.wav",
        me: "audio/sentences/shizukesa.wav"
      }
    },
    {
      romaji: "no",
    ...
    },
    {
      ...
      meaning: "by a ghost",
      audio: {
        daughter: "audio/sentences/yuurei_ni.wav",
        me: "audio/sentences/yuurei_ni.wav"
      }
    },
    {
...
function createAndWireLevel2ReplayButton(currentAudioChunks) {
  ...
  btn.onclick = () => {
    ...
    // ⭐ Kill ALL audio types (Level‑2 safe)
    L2.stopAllAudio();
    ...
    // ⭐ Reset cancel token for new replay
    if (L2.audio && L2.audio.cancelToken) {
...
L2.onComplete = function () {
  ...
  // ⭐ Prevent Level‑2 from restarting while on Screen2 or Screen4
  if (window.currentScreen === "level2Screen2" ||
      window.currentScreen === "level2Screen4") return;
  ...
  // Move to the next Level 2 screen
  L2.startRound();
};
...
function showLevel2FinalSummary() {
  ...
  // 🔇 Cancel any pending chunk callbacks
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = true;
  }
  ...
  // 🔇 Stop Level‑2 audio (normal Audio())
  if (typeof L2.stopAllAudio === "function") {
    L2.stopAllAudio();
  }

  // ⭐ Kill voicePlayer chunk queue
  if (window.voicePlayer && window.voicePlayer.stop) {
    window.voicePlayer.stop();
  }

  // ⭐ NEW — GLOBAL KILL SWITCH (fix)
  // Prevent leftover Level‑1 or Level‑2 replay callbacks from firing
  if (window.audioCancelToken) {
    window.audioCancelToken.cancel = true;
  }
...
// ⭐⭐⭐ LEVEL‑2 SAFE VERSION — NO LOGIC CHANGES ⭐⭐⭐
L2.playChunkSequence2 = function(i = 0, callback, chunksArray) {
  const chunks = chunksArray;
  const currentGen = L2.audio.generation;

  // ⭐ HARD STOP — allow only Screen1 and Screen2
  if (window.currentScreen !== "level2Screen1" &&
  ...
  if (!file) {
    if (currentGen !== L2.audio.generation) return;
    if (window.currentScreen !== "level2Screen1" &&
        window.currentScreen !== "level2Screen2") return;
...
L2.startRound = function () {
  ...
  // ⭐ HARD GUARD — only run when Level‑2 is truly active
  ...
  // ⭐ Reset audio safety WITHOUT killing audio
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = false;
  }
  if (L2.audio) {
...
L2.screen1 = function () {
  ...
  // Kill Level‑2 chunk engine (voicePlayer)
  if (window.voicePlayer && window.voicePlayer.stop) {
    window.voicePlayer.stop();
  }

  // Kill pending chunk callbacks
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = true;
  }

  // Invalidate ALL async callbacks
  if (L2.audio) {
    L2.audio.generation++;
    L2.audio.current = null;
  }

  // Reset cancel token for NEW Screen‑1 audio
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = false;
  }
  ...
  // Remove the correct chunk from the audio sequence
  ...
  // If no chunks, skip directly to MCQ
...
L2.screen2 = function () {
  ...
  // Reset cancel token for new Screen‑2 audio
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = false;
  }
...
L2.handleMCQ = function (choice) {
  ...
  // ⭐⭐⭐ HARD KILL — MUST BE FIRST ⭐⭐⭐
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = true;     // kill pending chunk callbacks
  }

  if (window.voicePlayer && window.voicePlayer.stop) {
    window.voicePlayer.stop();              // kill chunk queue
  }

  if (typeof L2.stopAllAudio === "function") {
    L2.stopAllAudio();                      // kill normal Audio()
  }

  if (L2.audio) {
    L2.audio.generation++;                  // invalidate async callbacks
    L2.audio.current = null;
  }
  // ⭐⭐⭐ END HARD KILL ⭐⭐⭐
...
L2.showRoundSummary = function () {
  ...
  // ⭐ Generation guard to invalidate pending callbacks
  if (L2.audio) {
    L2.audio.generation++;
    L2.audio.current = null;
  }
  ...
  // ⭐⭐⭐ ADDED LINE — DO NOT MOVE ⭐⭐⭐
  window.currentScreen = "level2Summary";
  ...
  document.getElementById("level2ReplayBtn").onclick = () => {
    ...
    // Only allow replay while actually on the summary screen
    if (window.currentScreen !== "level2Summary") return;
...
L2.start = function () {
  ...
  // Reset cancel token for NEW Level‑2 session
  if (L2.audio && L2.audio.cancelToken) {
    L2.audio.cancelToken.cancel = false;
  }
...
L2.showScreen2 = function(sentence) {
    ...
    // 🔇 Kill ALL Level‑2 audio
    L2.stopAllAudio();

    // ⭐ NEW — Kill voicePlayer chunk queue
    if (window.voicePlayer && window.voicePlayer.stop) {
        window.voicePlayer.stop();
    }

    // ⭐ NEW — Kill pending chunk callbacks
    if (L2.audio && L2.audio.cancelToken) {
        L2.audio.cancelToken.cancel = true;
    }

    // ⭐ NEW — Invalidate pending async callbacks
    if (L2.audio) {
        L2.audio.generation++;
        L2.audio.current = null;
    }
...

{
  ...
  chunks: [
    ...
    },
    {
      hiragana: "ほど",
      meaning: "the more you do",
      audio: { daughter: "audio/sentences/hodo.wav", me: "audio/sentences/hodo.wav" }
    },
    {
      hiragana: "じょうきょう",
      meaning: "situation",
...
L4.renderProgress = function (screenId) {
  ...
  const bar = wrapper.querySelector("#l4ProgressBar");
const label = wrapper.querySelector("#l4ProgressLabel");

bar.style.width = pct + "%";
label.textContent = `Progress: ${current} / ${total}`;
...
L4.startRound = function () {
  ...
  console.log("CURRENT SENTENCE OBJ:", sentence);   // ⭐ ADDED LINE
...
L4.screen2 = function () {
  ...
  // Use the SAME object Screen1 used
  const s = L4.screen1RandomObj;
  L4.currentSentenceObj = s;
  ...
  // Fallback if interjections[] missing
  if (!s.interjections || s.interjections.length === 0) {
    const distractors = L4.generateDistractors(s.correctInterjection);
    s.interjections = [s.correctInterjection, ...distractors];
  }

  // Build MCQ options
  const allOptions = [...s.interjections];
  ...
  allOptions.forEach(opt => {
    const btn = document.createElement("button");
    btn.className = "mcqBtn l4-mcq-btn";
    btn.textContent = opt;

    // ⭐ Minimal required fix
    btn.dataset.choice = opt;

    // ⭐ Minimal required fix — pass only the button
    btn.onclick = () => L4.handleMCQ(btn.dataset.choice, btn);
...
L6.showRoundSummary = function () {
  ...
  const s = L6.currentSentenceObj;
  if (!s) {
    console.error("L6.showRoundSummary() called with no sentence");
    return;
  }

  // ⭐ Apply Level 6 styling to the universal summary screen
  const screen3 = document.getElementById("screen3");
  screen3.classList.add("level6");

  // ⭐ Stop audio + show universal summary screen
  L6.stopAllAudio();
  L6.show("screen3");
  ...
  // ⭐ Chunk table (Hiragana / Romaji / English)
  const cont = document.getElementById("summaryContainer");
  cont.innerHTML = "";
  ...
  // ⭐ Replay button (full guard pattern)
  document.getElementById("screen3ReplayBtn").onclick = () => {
    console.log("[Level6] Replay sentence from summary");
  ...
  // ⭐ Next button
  document.getElementById("screen3NextBtn").onclick = () => {
    console.log("[Level6] Next round");

    L6.mcqLocked = true;
    L6.stopAllAudio();

    // ⭐ Remove Level 6 styling when leaving summary
    screen3.classList.remove("level6");

    // Hide summary
    document.getElementById("screen3")?.classList.add("hidden");

    // Restore Level 6 wrapper
    document.getElementById("screen2L6")?.classList.remove("hidden");
    document.getElementById("level6Wrapper")?.classList.remove("hidden");
...
case "light_plan":
  replies.push(
    politeness === "polite"
      ? pick([
          "そうなのですね…。こうえんに行くかどうか、すこし考えておられるのですね。",
          "なるほど…。本日はこうえんに行くかどうか、まだ決めていないのですね。",
          "そうですか…。こうえんに行くかどうか、ちょっと迷っているのですね。"
        ])
      : pick([
          "そっか…。こうえんに行くかどうか、ちょっと…",
          "なるほどね…。こうえんに行くかどうか、まだきめてないんだね。",
          "そっか…。こうえんに行くかどうか、すこし迷ってるんだね。"
        ])
  );
  break;
